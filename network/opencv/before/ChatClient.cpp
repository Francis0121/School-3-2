...
//TODO: call AfxInitRichEdit2() to initialize richedit2 library.
	...
	CCamSocket *p_cam_socket = new CCamSocket();
	TCHAR id[20] = {0};
	CChatConnector cdlg(p_client_socket, p_image_socket, p_cam_socket, id);
	if(IDOK == cdlg.DoModal()){
		CChatClientDlg dlg(p_client_socket, p_image_socket, p_cam_socket, id);
		m_pMainWnd = &dlg;
