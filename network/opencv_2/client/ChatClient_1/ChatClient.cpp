...
//TODO: call AfxInitRichEdit2() to initialize richedit2 library.
	...
	CClientWhiteBoardSocket *p_client_whiteBoard_socket = new CClientWhiteBoardSocket();
	CClientCamSocket *p_cam_socket = new CClientCamSocket();
	TCHAR id[20]={0};
	CChatConnector cdlg(p_client_socket, p_client_whiteBoard_socket, p_cam_socket, id);
	CChatClientDlg *tmp;
	if(IDOK == cdlg.DoModal())
	{
		CChatClientDlg dlg(p_client_socket, p_client_whiteBoard_socket, p_cam_socket,id);
		m_pMainWnd = &dlg;
		tmp = &dlg;
